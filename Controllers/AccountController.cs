...
namespace MVCDHProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void SendMail(IdentityUser identityUser, string requestLink, string subject)
        {
            ...
            MailboxAddress fromAddress = new MailboxAddress("Customer Support", "balarajuputta9@gmail.com");
            ...
            smtpClient.Authenticate("balarajuputta9@gmail.com", "sdah sktr pfbq iyfa");
